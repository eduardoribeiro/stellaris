//! Provides constructs for the Stellaris app version and release channel.
...
pub fn app_identifier() -> &'static str {
    match *RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Stellaris-Editor-Dev",
        ReleaseChannel::Nightly => "Stellaris-Editor-Nightly",
        ReleaseChannel::Preview => "Stellaris-Editor-Preview",
        ReleaseChannel::Stable => "Stellaris-Editor-Stable",
    }
}

/// The Git commit SHA that Stellaris was built at.
...
/// A Stellaris release channel.
#[derive(Debug, Copy, Clone, PartialEq, Eq, Default)]
pub enum ReleaseChannel {
    /// The development release channel.
    ///
    /// Used for local debug builds of Stellaris.
    #[default]
    Dev,
...
impl ReleaseChannel {
    ...
    pub fn display_name(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "Stellaris Dev",
            ReleaseChannel::Nightly => "Stellaris Nightly",
            ReleaseChannel::Preview => "Stellaris Preview",
            ReleaseChannel::Stable => "Stellaris",
        }
    }
    ...
    /// and WM_CLASS on X11.
    /// This also has to match the bundle identifier for Stellaris on macOS.
    pub fn app_id(&self) -> &'static str {
        match self {
            ReleaseChannel::Dev => "com.blutech.stellaris-Dev",
            ReleaseChannel::Nightly => "com.blutech.stellaris-Nightly",
            ReleaseChannel::Preview => "com.blutech.stellaris-Preview",
            ReleaseChannel::Stable => "com.blutech.stellaris",
        }
    }

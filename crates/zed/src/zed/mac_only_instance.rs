...
fn instance_handshake() -> &'static str {
    match *release_channel::RELEASE_CHANNEL {
        ReleaseChannel::Dev => "Stellaris Editor Dev Instance Running",
        ReleaseChannel::Nightly => "Stellaris Editor Nightly Instance Running",
        ReleaseChannel::Preview => "Stellaris Editor Preview Instance Running",
        ReleaseChannel::Stable => "Stellaris Editor Stable Instance Running",
    }
}
